...
try:
    for times in range(1):
        touch(Template(r"tpl1741930775370.png", record_pos=(0.204, -0.252), resolution=(2160, 1620)))   #アプリ起動する
        time.sleep(7)
        touch(Template(r"tpl1741930598457.png", record_pos=(-0.096, -0.173), resolution=(2160, 1620)))
        time.sleep(3)
